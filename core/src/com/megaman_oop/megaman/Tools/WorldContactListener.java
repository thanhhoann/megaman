        ...
        switch (cDef){
            ...
            case MegaMan.MARIO_HEAD_BIT | MegaMan.COIN_BIT:
                if(fixA.getFilterData().categoryBits == MegaMan.MARIO_HEAD_BIT)
                    ((InteractiveTileObject) fixB.getUserData()).onHeadHit((MainCharacter) fixA.getUserData());
                else
                    ((InteractiveTileObject) fixA.getUserData()).onHeadHit((MainCharacter) fixB.getUserData());
                break;
            case MegaMan.ENEMY_HEAD_BIT | MegaMan.MARIO_BIT:
                if(fixA.getFilterData().categoryBits == MegaMan.ENEMY_HEAD_BIT)
                    ...
                    ((Enemy)fixB.getUserData()).hitOnHead((MainCharacter) fixA.getUserData());
                break;
            ...
            case MegaMan.MARIO_BIT | MegaMan.ENEMY_BIT:
                if(fixA.getFilterData().categoryBits == MegaMan.MARIO_BIT)
                    ...
                    ((MainCharacter) fixB.getUserData()).hit((Enemy)fixA.getUserData());
                break;
            case MegaMan.ENEMY_BIT | MegaMan.ENEMY_BIT:
            ...
            case MegaMan.ITEM_BIT | MegaMan.MARIO_BIT:
                if(fixA.getFilterData().categoryBits == MegaMan.ITEM_BIT)
                    ...
                    ((Item)fixB.getUserData()).use((MainCharacter) fixA.getUserData());
                break;
