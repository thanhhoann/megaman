...
import com.megaman_oop.megaman.Sprites.Enemies.*;
...
public class MainCharacter extends Sprite {
    ...
    public void update(float dt){
        ...
        if(marioIsBig)
            setPosition(b2body.getPosition().x - getWidth() / 2, b2body.getPosition().y - getHeight() / 2 - 6 / MegaMan.PPM);
        else
    ...
    public void redefineMario(){
        ...
        fdef.filter.categoryBits = MegaMan.MARIO_BIT;
        ...
        fdef.filter.categoryBits = MegaMan.MARIO_HEAD_BIT;
        fdef.shape = head;
        fdef.isSensor = true;
    ...
    public void defineBigMario(){
        ...
        BodyDef bdef = new BodyDef();
        bdef.position.set(currentPosition.add(0, 10 / MegaMan.PPM));
        bdef.type = BodyDef.BodyType.DynamicBody;
        b2body = world.createBody(bdef);
    ...
    public void defineMario(){
        BodyDef bdef = new BodyDef();
        bdef.position.set(32 / MegaMan.PPM, 32 / MegaMan.PPM);
        bdef.type = BodyDef.BodyType.DynamicBody;
        b2body = world.createBody(bdef);
